...
The provided framework encompasses a comprehensive computational pipeline for Congenital Heart Disease (CHD) analysis from echocardiography videos. Specifically, it integrates robust data preprocessing, contrastive learning-based pre-training, single-view feature extraction, multi-view diagnostic classification, and the implementation of collaborative Explainable Artificial Intelligence (XAI)
...
```bash
git clone [https://github.com/strewberrr/CHD-XAI.git](https://github.com/strewberrr/CHD-XAI.git)
cd CHD-XAI
